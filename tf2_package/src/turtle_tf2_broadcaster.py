...
class FramePublisher(Node):
    def __init__(self):
        ...
        self.turtlename = self.declare_parameter('turtlename', 'turtle').get_parameter_value().string_value  # Declare and acquire `turtlename` parameter
    ...
    def handle_turtle_pose(self, msg):
        ...
        q=quaternion_from_euler(0, 0, msg.theta)    #rotation only around z axis
